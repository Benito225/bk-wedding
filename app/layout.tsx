    ...
    <html lang="fr">
      ...
      <Providers>
          <div className={`min-h-screen relative flex justify-center items-center overflow-x-hidden`}>
              ...
              <div className={`h-[8rem] w-[8rem] md:h-[12rem] md:w-[12rem] lg:h-[12rem] lg:w-[12rem] xl:h-[16rem] xl:w-[16rem] absolute -top-3 -left-3 lg:-top-6 lg:left-0`}>
                  <Image className={`object-fill`} src={`/images/FLEUR-.png`} alt={`Fleur gauche`} fill />
              </div>
              <div className={`h-[8rem] w-[8rem] md:h-[12rem] md:w-[12rem] lg:h-[14rem] lg:w-[14rem] xl:h-[16rem] xl:w-[16rem] absolute bottom-0 -right-4 lg:bottom-0 lg:-right-4`}>
